...
class Constants
{
    ...
    const WHATSAPP_VER = '2.16.13';                                                         // The WhatsApp version.
    const OS_VERSION = '4.3';
    const MANUFACTURER = 'Xiaomi';
    const BUILD_VERSION = 'JLS36C';
    const PLATFORM = 'Android';                                                              // The device name.
    const WHATSAPP_USER_AGENT = 'WhatsApp/2.16.13 Android/4.3 Device/Xiaomi-HM_1SW';        // User agent used in request/registration code.
